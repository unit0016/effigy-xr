  ...
  render() {
    ...
    const header = (
      <Section>
        ...
        <p>
          <b>Thanks to: </b>
          Traditional Games 13, Skyrat Station, Baystation 12, /vg/station,
          NTstation, CDK Station devs, FacepunchStation, GoonStation devs, the
          original Space Station 13 developers, and the countless others who
          have contributed to the game.
        </p>
        <p>
          {'Current project maintainers can be found '}
          <a href="https://github.com/effigy-se?tab=members">here</a>
          {', recent GitHub contributors can be found '}
          <a href="https://github.com/effigy-se/effigy-xr/pulse/monthly">
            here
          </a>
          .
        </p>
